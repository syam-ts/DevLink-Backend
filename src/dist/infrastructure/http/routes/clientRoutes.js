...
clientRouter.post("/contractSubmitReject", verifyToken_1.verifyToken, (0, requireRole_1.requireRole)(CLIENT), rejectContract);
...
clientRouter.post('/withdrawMoney', verifyToken_1.verifyToken, (0, requireRole_1.requireRole)(CLIENT), withdrawMoneyByClient);
