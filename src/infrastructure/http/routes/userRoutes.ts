...
userRouter.get('/notifications/:userId', verifyToken, requireRole('user'), userController.allNotifications);
...
// userRouter.post('/job/createProposal/:clientId/:userId/:jobPostId', verifyToken, requireRole('user'), userController.createProposal);  
